...
const (
	...
	ContentService_ListCommentReplies_FullMethodName = "/pb.ContentService/ListCommentReplies"
...
func (c *contentServiceClient) ListCommentReplies(ctx context.Context, in *ListCommentRepliesRequest, opts ...grpc.CallOption) (*ListCommentRepliesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListCommentRepliesResponse)
	err := c.cc.Invoke(ctx, ContentService_ListCommentReplies_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedContentServiceServer) ListCommentReplies(context.Context, *ListCommentRepliesRequest) (*ListCommentRepliesResponse, error) {
...
func (UnimplementedContentServiceServer) RejectPost(context.Context, *RejectPostRequest) (*RejectPostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RejectPost not implemented")
}
func (UnimplementedContentServiceServer) TakedownPost(context.Context, *TakedownPostRequest) (*TakedownPostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TakedownPost not implemented")
}
...
func _ContentService_ListCommentReplies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListCommentRepliesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContentServiceServer).ListCommentReplies(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ContentService_ListCommentReplies_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContentServiceServer).ListCommentReplies(ctx, req.(*ListCommentRepliesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ContentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ContentService_ListCommentReplies_Handler,
		},
		{
			MethodName: "LikePost",
